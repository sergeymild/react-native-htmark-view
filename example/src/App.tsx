...
export default function App() {
  ...
  const html = `<span style="font-size:20px;color: blue;">first first first<b>first</b>first <a href="https://google.com">link</a> firstfirstfirstfirstfirstfirstfirstfirstfirst12345678firstfirstfirstfirstfirstfirstfirstfirstfirst<span style="color: green;">first</span>first12345678</span>`;
